...
// 示例：将下面两行替换为你自己的真实值
export const WECOM_TOKEN = "1111111111" // 例如："YourWecomToken"
export const WECOM_ENCODING_AES_KEY = "1111111111111111111111111111111111111111111" // 43 位，例如："abcdefghijklmnopqrstuvwxyz0123456789ABCDEFG"
