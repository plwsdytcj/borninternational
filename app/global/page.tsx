...
import { ArrowLeft, Globe, ChevronDown, MapPin, Users, Building, TrendingUp } from 'lucide-react'
...
export default function GlobalPage() {
  ...
  const languageContent = {
    en: {
      ...
      globalNetworkDescription: "Our worldwide presence enables us to identify opportunities and manage investments across diverse markets and sectors",
      backToHome: "Back to Home",
      founderSection: "Leadership",
      founderName: "Dr. James Chen",
      founderTitle: "Founder & Managing Partner",
      founderDescription: "With over 20 years of experience in venture capital and technology investments, Dr. Chen has led Born International's expansion across global markets. He holds a PhD in Computer Science from Stanford University and has been instrumental in identifying and nurturing breakthrough technologies.",
      eurasianRegion: "Eurasian Region",
      eurasianDescription: "Strategic partnerships across Russia, Central Asia, and the Shanghai Cooperation Organization (SCO) member states, with a focus on technology transfer and cross-border innovation.",
      ...
      euDescription: "Comprehensive coverage across EU markets with focus on deep tech, sustainability, and digital transformation initiatives.",
      ...
      middleEastDescription: "Strategic presence in UAE, Saudi Arabia, and Israel, focusing on fintech, energy transition, and smart city technologies.",
      ...
      southAfricaDescription: "Gateway to African markets with emphasis on mobile technology, renewable energy, and financial inclusion solutions.",
      ...
      sectorsDescription: "Our diversified portfolio spans multiple high-growth sectors, each managed by specialized teams with deep domain expertise.",
    ...
    ru: {
      ...
      globalNetworkDescription: "Наше всемирное присутствие позволяет нам выявлять возможности и управлять инвестициями на различных рынках и в различных секторах",
      backToHome: "Вернуться на главную",
      founderSection: "Руководство",
      founderName: "Доктор Джеймс Чен",
      founderTitle: "Основатель и управляющий партнер",
      founderDescription: "Имея более 20 лет опыта в венчурном капитале и технологических инвестициях, доктор Чен возглавил расширение Born International на мировых рынках. Он имеет степень доктора компьютерных наук Стэнфордского университета и сыграл ключевую роль в выявлении и развитии прорывных технологий.",
      eurasianRegion: "Евразийский регион",
      eurasianDescription: "Стратегические партнерства в России, Центральной Азии и государствах-членах Шанхайской организации сотрудничества (ШОС) с акцентом на передачу технологий и трансграничные инновации.",
      ...
      euDescription: "Комплексное покрытие рынков ЕС с акцентом на глубокие технологии, устойчивость и инициативы цифровой трансформации.",
      ...
      middleEastDescription: "Стратегическое присутствие в ОАЭ, Саудовской Аравии и Израиле с акцентом на финтех, энергетический переход и технологии умных городов.",
      ...
      southAfricaDescription: "Ворота на африканские рынки с акцентом на мобильные технологии, возобновляемую энергию и решения финансовой инклюзии.",
      ...
      sectorsDescription: "Наш диверсифицированный портфель охватывает множество быстрорастущих секторов, каждый из которых управляется специализированными командами с глубокой экспертизой в предметной области.",
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              {content.globalNetworkDescription}
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-slate-600 mb-6 leading-relaxed">
                  {content.southAfricaDescription}
                </p>
                <div className="mb-6">
                  <div className="flex items-center mb-3">
                    <Users className="w-5 h-5 text-slate-500 mr-2" />
      ...
      <section className="py-20 relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {/* Row 1 */}
            <Card className="col-span-2 bg-gradient-to-br from-blue-500 to-blue-600 text-white border-0 shadow-lg hover:shadow-xl transition-all hover:scale-105">
              <CardContent className="p-6 h-32 flex flex-col justify-center">
                <h4 className="text-lg font-semibold mb-2">{content.medicalSector}</h4>
                <p className="text-sm opacity-90">{content.medicalDescription}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white border-0 shadow-lg hover:shadow-xl transition-all hover:scale-105">
              <CardContent className="p-6 h-32 flex flex-col justify-center">
                <h4 className="text-lg font-semibold mb-2">{content.newEnergySector}</h4>
                <p className="text-sm opacity-90">{content.newEnergyDescription}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white border-0 shadow-lg hover:shadow-xl transition-all hover:scale-105">
              <CardContent className="p-6 h-32 flex flex-col justify-center">
                <h4 className="text-lg font-semibold mb-2">{content.aiSector}</h4>
                <p className="text-sm opacity-90">{content.aiDescription}</p>
              </CardContent>
            </Card>

            {/* Row 2 */}
            <Card className="bg-gradient-to-br from-orange-500 to-orange-600 text-white border-0 shadow-lg hover:shadow-xl transition-all hover:scale-105">
              <CardContent className="p-6 h-32 flex flex-col justify-center">
                <h4 className="text-lg font-semibold mb-2">{content.fintechSector}</h4>
                <p className="text-sm opacity-90">{content.fintechDescription}</p>
              </CardContent>
            </Card>

            <Card className="bg-gradient-to-br from-indigo-500 to-indigo-600 text-white border-0 shadow-lg hover:shadow-xl transition-all hover:scale-105">
              <CardContent className="p-6 h-32 flex flex-col justify-center">
                <h4 className="text-lg font-semibold mb-2">{content.spaceSector}</h4>
                <p className="text-sm opacity-90">{content.spaceDescription}</p>
              </CardContent>
            </Card>

            <Card className="col-span-2 bg-gradient-to-br from-pink-500 to-pink-600 text-white border-0 shadow-lg hover:shadow-xl transition-all hover:scale-105">
              <CardContent className="p-6 h-32 flex flex-col justify-center">
                <h4 className="text-lg font-semibold mb-2">{content.quantumSector}</h4>
                <p className="text-sm opacity-90">{content.quantumDescription}</p>
              </CardContent>
            </Card>

            {/* Row 3 */}
            <Card className="col-span-2 bg-gradient-to-br from-teal-500 to-teal-600 text-white border-0 shadow-lg hover:shadow-xl transition-all hover:scale-105">
              <CardContent className="p-6 h-32 flex flex-col justify-center">
                <h4 className="text-lg font-semibold mb-2">{content.roboticsSector}</h4>
                <p className="text-sm opacity-90">{content.roboticsDescription}</p>
              </CardContent>
            </Card>

            <Card className="col-span-2 bg-gradient-to-br from-red-500 to-red-600 text-white border-0 shadow-lg hover:shadow-xl transition-all hover:scale-105">
              <CardContent className="p-6 h-32 flex flex-col justify-center">
                <h4 className="text-lg font-semibold mb-2">{content.bioSector}</h4>
                <p className="text-sm opacity-90">{content.bioDescription}</p>
              </CardContent>
            </Card>
          </div>
        </div>
