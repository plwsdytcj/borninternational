...
export default function MotherFundPage() {
  ...
  const languageContent = {
    en: {
      ...
      fundDescription: "The fund is positioned as a mother fund, directly managing 166 million yuan, and has currently entered the post-investment management and exit period.",
      investmentDetails: "The invested funds include Dianliang Capital Ningbo Fund, Fukun Venture Capital Chengdu Fund, Hongtai (Chengdu) Fund, Chengdu Dianliang Born Fund, etc.",
      ecosystemAdvantage: "Relying on the investment fields and stages covered by various sub-funds, Born Rongchuang Fund has leveraged the advantages of an 'ecosystem fund', assisting the development of terminal invested enterprises through resource connection and empowerment.",
    ...
    ru: {
      ...
      fundDescription: "Фонд позиционируется как материнский фонд, напрямую управляющий 166 миллионами юаней, и в настоящее время вошел в период пост-инвестиционного управления и выхода.",
      investmentDetails: "Инвестированные фонды включают Фонд Dianliang Capital Ningbo, Фонд Fukun Venture Capital Chengdu, Фонд Hongtai (Chengdu), Фонд Chengdu Dianliang Born и др.",
      ecosystemAdvantage: "Опираясь на инвестиционные области и этапы, охватываемые различными суб-фондами, Фонд Born Rongchuang использовал преимущества 'экосистемного фонда', помогая развитию конечных инвестированных предприятий через связывание ресурсов и расширение возможностей.",
  ...
  const investmentCommittee = [
    ...
    },
    {
      ...
      description: "Chairman of Qingdao Danxiang Group; has participated in investments in Weiying Company, Yuren Manufacturing, Caitong Fund and other companies in the field of equity investment.",
      descriptionRu: "Председатель группы Qingdao Danxiang; участвовал в инвестициях в компании Weiying, Yuren Manufacturing, Caitong Fund и другие компании в области инвестиций в акционерный капитал.",
      image: "/placeholder-user.jpg"
    },
    {
      name: "Sun Qibin",
    ...
    },
    {
      ...
      descriptionRu: "Генеральный менеджер компании экологического оборудования Shandong Jinsanbao и основатель-партнер Born Capital. Имеет богатый практический и инвестиционный опыт в области охраны окружающей среды и интеллектуального производства, глубоко развернул новые технологические предприятия в области охраны окружающей среды, интеллектуального производства и других областях.",
      image: "/placeholder-user.jpg"
    },
    {
      name: "Wang Jianqiu",
      ...
      description: "Vice Chairman of Yantai Catering and Culinary Industry Association, Chairman of Shandong Douxian Catering Management Co., Ltd., Chairman of Yantai Wanhua Catering Management Co., Ltd., and has won the honorary title of 'Outstanding Female Entrepreneur of Yantai'. Ms. Wang Jianqiu focuses on investment in technology fields and has participated in investments in excellent projects such as Sandi Jianke.",
      descriptionRu: "Вице-председатель Ассоциации ресторанного и кулинарного бизнеса Яньтая, председатель Shandong Douxian Catering Management Co., Ltd., председатель Yantai Wanhua Catering Management Co., Ltd., получила почетное звание 'Выдающийся женщина-предприниматель Яньтая'. Г-жа Ван Цзяньцю сосредоточена на инвестициях в технологические области и участвовала в инвестициях в отличные проекты, такие как Sandi Jianke.",
      image: "/placeholder-user.jpg"
    },
    {
      name: "Yang Jie",
    ...
    },
    {
      ...
      description: "Founding Partner of Born Capital, Partner of Dianliang Born, with rich investment experience, specializing in Internet, education, consumption upgrade, Internet of Things and other fields.",
      descriptionRu: "Основатель-партнер Born Capital, партнер Dianliang Born, с богатым инвестиционным опытом, специализирующийся в области Интернета, образования, модернизации потребления, Интернета вещей и других областях.",
      image: "/placeholder-user.jpg"
    },
    {
      name: "Li Wencheng",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section 
        ...
        style={{
          backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/1-210914110R4c6_X-Design.jpg-RF2OJ0PUCCp2Liuytq7PXBppZcO22F.jpeg')"
        }}
      >
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-3/4">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-slate-700 mb-4"><strong>{content.establishedDate}</strong></p>
