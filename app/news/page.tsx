...
export default function NewsPage() {
  ...
  const newsArticles = [
    {
      ...
      excerpt_en: "The fund returned 4.9% in the fourth quarter, corresponding to a gain of NOK 980 billion. This strong performance was driven by robust equity markets and strategic positioning.",
      excerpt_ru: "Фонд вернул 4,9% в четвертом квартале, что соответствует прибыли в 980 миллиардов норвежских крон. Этот сильный результат был обусловлен устойчивыми фондовыми рынками и стратегическим позиционированием.",
    ...
    },
    {
      ...
      excerpt_en: "New framework for investing in companies that contribute to the green transition. We are committed to supporting sustainable business practices and environmental responsibility.",
      excerpt_ru: "Новая основа для инвестирования в компании, которые вносят вклад в зеленый переход. Мы привержены поддержке устойчивых деловых практик и экологической ответственности.",
    ...
    },
    {
      ...
      excerpt_en: "Our expectations for global markets and investment opportunities in the year ahead. Key trends include technological innovation and emerging market growth.",
      excerpt_ru: "Наши ожидания относительно мировых рынков и инвестиционных возможностей в предстоящем году. Ключевые тенденции включают технологические инновации и рост развивающихся рынков.",
    ...
    },
    {
      ...
      excerpt_en: "Strategic expansion into Singapore and Hong Kong markets, establishing new partnerships with local investment firms and technology companies.",
      excerpt_ru: "Стратегическое расширение на рынки Сингапура и Гонконга, установление новых партнерских отношений с местными инвестиционными фирмами и технологическими компаниями.",
    ...
    },
    {
      ...
      excerpt_en: "Our portfolio company QBoson achieves major milestone with 1000+ qubit quantum computer, attracting global attention from tech giants.",
      excerpt_ru: "Наша портфельная компания QBoson достигает важной вехи с квантовым компьютером с более чем 1000 кубитами, привлекая глобальное внимание технологических гигантов.",
  ...
  const languageContent = {
    en: {
      ...
      newsletterDescription: "Subscribe to our newsletter to receive the latest news and insights directly in your inbox",
    ...
    ru: {
      ...
      newsletterDescription: "Подпишитесь на нашу рассылку, чтобы получать последние новости и аналитику прямо в ваш почтовый ящик",
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              {languageContent[language].newsDescription}
            </p>
          </div>
      ...
      <section className="py-16 relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <Input 
              placeholder={languageContent[language].enterYourEmail}
              className="flex-1 bg-white text-slate-900"
            />
            <Button className="bg-blue-600 hover:bg-blue-700">
              {languageContent[language].subscribe}
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><a href="#" className="hover:text-white">{languageContent[language].aboutTheFund}</a></li>
                <li><a href="#" className="hover:text-white">{languageContent[language].investmentStrategy}</a></li>
                <li><a href="#" className="hover:text-white">{languageContent[language].returns}</a></li>
                <li><a href="#" className="hover:text-white">{languageContent[language].holdings}</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><a href="#" className="hover:text-white">{languageContent[language].ourApproach}</a></li>
                <li><a href="#" className="hover:text-white">{languageContent[language].climate}</a></li>
                <li><a href="#" className="hover:text-white">{languageContent[language].ownership}</a></li>
                <li><a href="#" className="hover:text-white">{languageContent[language].exclusions}</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><a href="#" className="hover:text-white">{languageContent[language].organization}</a></li>
                <li><a href="#" className="hover:text-white">{languageContent[language].careers}</a></li>
                <li><a href="#" className="hover:text-white">{languageContent[language].contact}</a></li>
                <li><Link href="/news" className="hover:text-white">{languageContent[language].press}</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-slate-400 hover:text-white text-sm">{languageContent[language].privacyPolicy}</a>
              <a href="#" className="text-slate-400 hover:text-white text-sm">{languageContent[language].termsOfUse}</a>
              <a href="#" className="text-slate-400 hover:text-white text-sm">{languageContent[language].accessibility}</a>
            </div>
          </div>
        </div>
      </footer>
